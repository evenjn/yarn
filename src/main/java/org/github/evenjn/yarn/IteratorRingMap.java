...
/**
 * <h1>IteratorRingMap</h1>
 * 
 * <p>
 * An {@code IteratorRingMap} is a
 ...
 */
@FunctionalInterface
public interface IteratorRingMap<I, O> extends
		YarnRingMap<I, O, Iterator<O>> {

	/**
	 * <p>
	 * {@code get} returns a {@link java.util.Iterator Iterator} with output
